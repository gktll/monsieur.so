...
class EphemerisCalculator:
    ...
    # ---------------------------------------------
    # CALCULATE SUNTIME BASING ON LAT / LONG -  IMPLEMENTED
    # ---------------------------------------------
    ...
    # ---------------------------------------------
    # CALCULATE CURRENT PLANETARY HOUR -  IMPLEMENTED
    # ---------------------------------------------
    ...
    # ---------------------------------------------
    # CALCULATE CURRENT PLANETARY POSITIONS -  IMPLEMENTED
    # ---------------------------------------------
    ...
    # ------------------------------------------------------
    # CALCULATE PLANETARY DISTANCES FROM EARTH / OBSERVER -  IMPLEMENTED
    # -------------------------------------------------------
    ...
    # ------------------------------------------------------
    # CALCULATE COMBUSTION / CAZIMI / OUT OF BOUND -  IMPLEMENTED
    # -------------------------------------------------------
    ...
    # ------------------------------------------------------------------
    # CALCULATE ASPECTS [OPPOSITION, CONJUCTION, TRINE, SQUARE, SEXTILE] - -  IMPLEMENTED
    # -------------------------------------------------------------------
    ...
    # ------------------------------------------------------------------
    # CALCULATE MOON SPECIFIC PROPERTIES -  IMPLEMENTED
    # -------------------------------------------------------------------
    ...
    # -------------------------------------------------------------------------------
    # DATABASE QUERY FORMAT NEO4J QUERY : IMPLEMENTED
    # -------------------------------------------------------------------------------
    ...
    # -------------------------------------------------------------------------------
    # DATABASE QUERY CURRENT MAGIC HOUR : IMPLEMENTED
    # -------------------------------------------------------------------------------
